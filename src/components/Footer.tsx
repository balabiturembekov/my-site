    ...
    <footer className="w-full py-8 bg-white border-t mt-12">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-4">
          <a href="https://instagram.com/balabi_turembekov" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600"><Instagram /></a>
          <a href="mailto:turembek_b@icloud.com" className="hover:text-blue-600"><Mail /></a>
          <a href="tel:+77004411994" className="hover:text-blue-600"><Phone /></a>
        </div>
      </div>
